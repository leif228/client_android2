    ...
    private class EditChangedListener implements TextWatcher {
        ...
        public void onTextChanged(CharSequence charSequence, int i1, int i2, int i3) {
            if (!"".equals(charSequence.toString())) {
                ...
                //更新autoComplete数据
                for (int i = 0, count = 0; i < upsdList.size() && count < NewPageHomeMainActivity.hintSize; i++) {
                	if (upsdList.get(i).getShipName().contains(charSequence.toString().trim())) {
                		autoCompleteData.add(upsdList.get(i).getShipName());
                		count++;
                	}
                }
...
//        void onTipsItemClick(String text);
	...
	public void setDatas(List<UserPowerShipData> upsdList) {
		this.upsdList = upsdList;
	}

	public void setAutoCompleteData(List<String> autoCompleteData) {
