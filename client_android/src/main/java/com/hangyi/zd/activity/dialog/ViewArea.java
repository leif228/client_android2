...
//			}
//		});
        NewContentFragment.displayClickBigImage(mImageLoader,context,touchView,curShip,i);
...
//    }
//    public void playImg(ShipCooordData curShip){
//    	NewContentFragment.displayImage(mImageLoader,context,touchView,curShip,i);
//    }
	...
	public void setCurShip(ShipCooordData curShip) {
		this.curShip = curShip;
	}
