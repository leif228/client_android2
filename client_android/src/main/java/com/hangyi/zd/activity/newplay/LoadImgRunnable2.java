...
public class LoadImgRunnable2 implements Runnable {
	...
	public LoadImgRunnable2(String shipID, Data_loader dataLoader, List<String> channels, ImgLocalSaveService.ServiceBinder mBinderService, StartTimeEndTimeData data) {
