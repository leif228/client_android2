...
public class GroupAdapter extends BaseAdapter {
	...
	private ArrayList<GroupData> mAppList;
	...
	public GroupAdapter(Context c, List<GroupData> shipSCDataList) {
		this.mAppList = (ArrayList<GroupData>) shipSCDataList;
		this.mContext = c;
...
//		mImageLoader.init(imageLoaderConfiguration);
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		if (convertView != null) {
			...
			convertView = mInflater.inflate(R.layout.zd_group_item, null);
...
//			holder.btnPublish = (Button) convertView.findViewById(R.id.btnPublish);
		...
		final GroupData appInfo = mAppList.get(position);
		if (appInfo != null) {
...
//			holder.shipId.setText((String) appInfo.get("shipId"));
			holder.shipName.setText((String) appInfo.getGroupName());
...
//			});
	...
	class lvButtonListener implements OnClickListener {
		...
		public void onClick(View v) {
			GroupData s =mAppList.get(position);
