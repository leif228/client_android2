...
public class SearchShipAdapter1 extends BaseAdapter {
	...
	private List<ShipCooordData> mAppList;
...
//    .build(); 
	...
	public SearchShipAdapter1(Context c, List<ShipCooordData> shipCooordDatas) {
...
//		mImageLoader.init(imageLoaderConfiguration);
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		if (convertView != null) {
			...
			convertView = mInflater.inflate(R.layout.zd_ship_item2, null);
			holder = new buttonViewHolder();
			holder.item_birth =(TextView)convertView.findViewById(R.id.item_birth);
			convertView.setTag(holder);
		}

		ShipCooordData appInfo = mAppList.get(position);
		if (appInfo != null) {
