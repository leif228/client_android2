...
public class DateUtils {
	...
	public static String getDate(String pattern) {
		...
		return DateUtils.getTime(pattern);
	}
	...
	public static String getDate(Date date, String pattern) {
		...
		return DateUtils.getTime(date, pattern);
	}
	...
	/** 两个时间相差距离多少天多少小时多少分 */
	public static String getDistanceTime2(String str1, String str2, String pattern) {
		if (pattern == null || pattern.equals("")) {
	...
	public static void main(String args[]) {
		String m = "201312";
		String n = DateUtils.getAfterMonth(m, null);
