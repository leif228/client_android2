 ...
 *
 */
public class ShipDuesPayActivity extends CommonListActivity implements
		OnClickListener {
	Data_loader data;
	...
	protected void onCreate(Bundle arg0) {
		...
		mWebView.setWebViewClient(new WebViewClient() {
			...
			public void onPageStarted(WebView view, String url, Bitmap favicon) {
				...
				// "页面加载中，请稍候..");
				Toast.makeText(ShipDuesPayActivity.this, "页面加载中，请稍候...",
		...
		String totalFee = pe.getPrice();
			mWebView.loadUrl(ApplicationConstants.SERVER_URL
					+ "/payment/shipDues/?sellerEmail=" + sellerEmail
	...
	protected void onDestroy() {
		super.onDestroy();
		Intent intent = new Intent(ShipDuesPayActivity.this,ShipDuesActivity.class);
