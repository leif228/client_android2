...
public class DlrFragment extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		view = inflater.inflate(R.layout.eyd_chat_activity_contact, container,
				false);
		return view;
	}
	...
	public void onActivityCreated(Bundle savedInstanceState) {
		...
		getActivity()
				.registerReceiver(userOnlineStatusBroadcast, intentFilter1);
	...
	public boolean onContextItemSelected(MenuItem item) {
		...
		case R.id.send_notify:
			...
			getActivity().startActivity(new Intent(getActivity(),SendNotifyActivity.class)
							.putExtra("to", to.getUserData().getId().toString())
							.putExtra("toUserName", to.getUserData().getNickName()));
			break;
		}
		return true;
	}
