 ...
 *
 */
public class ShipGasOrderRefundActivity extends CommonListActivity implements
		OnClickListener {
	Data_loader data;
...
//						"页面加载中，请稍候..");
				Toast.makeText(ShipGasOrderRefundActivity.this, "页面加载中，请稍候...", Toast.LENGTH_SHORT).show();
			}
