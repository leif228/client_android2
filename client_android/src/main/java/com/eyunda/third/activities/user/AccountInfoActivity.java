...
public class AccountInfoActivity extends CommonListActivity implements
		OnClickListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		accountData = (AccountData) getIntent().getSerializableExtra("user");
		...
		AsyncHttpResponseHandler handler = new AsyncHttpResponseHandler() {
			...
			public void onSuccess(String content) {
				...
				if (map.get("returnCode").equals("Success")) {
					Toast.makeText(AccountInfoActivity.this, "信息提交成功", 1)
							.show();
					finish();
