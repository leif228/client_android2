...
import com.eyunda.third.activities.ship.widget.AlertSearchGasOrderDialog;
...
public class GasOrderActivity extends CommonListActivity implements
...
//				DialogUtil dialogAlert1 = new DialogUtil(GasOrderActivity.this);
//				dialogAlert1.showDialogFromConfig("提示", "确认要发起退款申请么?", new Handler() {
//					@Override
//					public void handleMessage(Message msg) {
//						super.handleMessage(msg);
//						//异步后台删除item
...
//									Intent intent = new Intent(GasOrderActivity.this,GasOrderActivity.class);
//									startActivity(intent);
//									finish();
//								}else
//									Toast.makeText(GasOrderActivity.this, cd.getMessage(), Toast.LENGTH_LONG).show();
//							}
//						};
//						Map<String, Object> params = new HashMap<String, Object>();
//						params.put("billId",id);
//						params.put("paySourceCode",PaySourceCode.buyerpay);
//						data.getApiResult(handler, "/mobile/wallet/myWallet/refund", params, "post");	
//						
//					}
//				});
...
//				loadPay(id2);
//				startActivity(new Intent(GasOrderActivity.this, PayMoneyActivity.class)
//										.putExtra(PayMoneyActivity.PAY_SOURCE,PaySourceCode.buyerpay.toString())
//										.putExtra("id",id2.toString()));
//				startActivity(new Intent(ShipDuesActivity.this, ShipDuesRefundActivity.class));
//				Toast.makeText(ShipDuesActivity.this, "退款shipDuesId="+id, Toast.LENGTH_LONG).show();
				break;
			case MSG_Del_One_Item: // 删除一个Item
				...
				DialogUtil dialogAlert = new DialogUtil(GasOrderActivity.this);
...
//					 bundle.putString("shipName", shipName);
					 ...
					 startActivity(new Intent(GasOrderActivity.this,ShipGasOrderPaymentActivity.class).putExtras(bundle));
				} else {
					Toast.makeText(GasOrderActivity.this, cd.getMessage(),Toast.LENGTH_LONG).show();
				}
			}
			...
			public void onFailure(Throwable arg0, String content) {
				...
				if (content != null && content.equals("can't resolve host"))
					Toast.makeText(GasOrderActivity.this, "网络连接异常",Toast.LENGTH_LONG).show();
				else if (content != null && content.equals("socket time out")) {
					Toast.makeText(GasOrderActivity.this, "连接服务器超时",Toast.LENGTH_LONG).show();
				} else if (content != null) {
					Toast.makeText(GasOrderActivity.this, content,Toast.LENGTH_LONG).show();
				} else
					Toast.makeText(GasOrderActivity.this, "未知异常",Toast.LENGTH_LONG).show();
			}
	...
	protected void loadRefund(Long id) {
		...
		AsyncHttpResponseHandler handler = new AsyncHttpResponseHandler() {
			...
			public void onSuccess(String arg0) {
				...
				ConvertData cd = new ConvertData(arg0);
				if (cd.getReturnCode().equals("Success")) {
					startActivity(new Intent(GasOrderActivity.this, ShipGasOrderRefundActivity.class));
				} else {
					Toast.makeText(GasOrderActivity.this, cd.getMessage(),Toast.LENGTH_LONG).show();
				}
			}
...
//			});
		setRight(R.drawable.ic_action_search,new OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				final AlertSearchGasOrderDialog ad = new AlertSearchGasOrderDialog(GasOrderActivity.this);
				ad.showAddDialog(new DialogInterface.OnClickListener() {
					@Override
					public void onClick(DialogInterface dialog, int which) {
						ShipNameData selectShip = ad.getSelectShip();
						if(selectShip.getMmsi().equals("")){
							statusCode = "";
							page=1;
							dataList.clear();
							loadDate();
						}else{
							statusCode = selectShip.getMmsi();
							page=1;
							dataList.clear();
							loadDate();
						}
	...
	protected BaseAdapter setAdapter() {
		...
		smpAdapter = new ShipGasOrderAdapter(GasOrderActivity.this, mHandler,dataList);
