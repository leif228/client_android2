...
import com.eyunda.third.adapters.chat.FileChooserAdapter;
import com.eyunda.third.adapters.chat.FileChooserAdapter.FileInfo;
...
//			else if(fileInfo.isPPTFile()){  //是ppt文件 ， 则将该路径通知给调用者
			    ...
			    intent.putExtra(ChatActivity.EXTRA_FILE_CHOOSER , fileInfo.getFilePath());
