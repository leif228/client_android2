...
public class ShipApplyData extends BaseData {
	private static final long serialVersionUID = -1L;

	private Long id = 0L; // ID
	// private Long shipId = 0L; // 船舶ID
	private String mmsi = ""; // 船舶MMSI编号
	...
	public ShipApplyData(Map<String, Object> params) {
		...
		if (params != null && !params.isEmpty()) {
			...
			this.cargoTypeDescrip = (String) params.get("cargoTypeDescrip");
	...
	public void setCargoType(CargoTypeCode cargoType) {
		...
		if (cargoType.getCargoBigType() == CargoBigTypeCode.container)
			this.cargoTypeDescrip = CargoBigTypeCode.container.getDescription();
		else
			this.cargoTypeDescrip = cargoType.getDescription();
	}

	public String getCargoTypeDescrip() {
		return cargoTypeDescrip;
	}

	public void setCargoTypeDescrip(String cargoTypeDescrip) {
		this.cargoTypeDescrip = cargoTypeDescrip;
	}
	...
	public String toString() {
		return "ShipPriceData [id=" + id + ", mmsi=" + mmsi + ", startPortNo=" + startPortNo + ", endPortNo="
				+ endPortNo + ", startPortData=" + startPortData + ", endPortData=" + endPortData + ", goodWeight="
				+ goodWeight + ", transFee=" + transFee + ", intTransFee=" + intTransFee + ", periodCode=" + periodCode
				+ ", periodTime=" + periodTime + ", createTime=" + createTime + "]";
	}
